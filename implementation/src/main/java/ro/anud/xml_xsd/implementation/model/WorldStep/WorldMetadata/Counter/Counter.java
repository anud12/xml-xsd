...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Counter  {
    ...
    private List<Consumer<Counter>> onChangeList = new ArrayList<>();
    ...
    public static Optional<Counter> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Counter::fromRawNode));
    }
    public static List<Counter> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Counter> returnList = rawNodeList.stream().map(Counter::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Counter> onChange) {
      logEnter();
