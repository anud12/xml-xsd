...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class DoElement  {
    ...
    public static Optional<DoElement> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(DoElement::fromRawNode));
    }
    public static List<DoElement> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<DoElement> returnList = rawNodeList.stream().map(DoElement::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<DoElement> onChange) {
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      rawNode.setAttribute("action_ref", this.actionRef);
