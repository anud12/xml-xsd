...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class StartingNode  {
    ...
    public static Optional<StartingNode> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(StartingNode::fromRawNode));
    }
    public static List<StartingNode> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<StartingNode> returnList = rawNodeList.stream().map(StartingNode::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<StartingNode> onChange) {
