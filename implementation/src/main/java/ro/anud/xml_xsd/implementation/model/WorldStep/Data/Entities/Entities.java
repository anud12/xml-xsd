package ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Entities implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.data.entities";
    }
    ...
    //Children elements
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity> entity = new ArrayList<>();
    ...
    public void removeChild(Object object) {
        if(object instanceof ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("children")) {
          ...
          this.entity = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity.fromRawNode(rawNode.getChildrenList("entity"), this);
        }
    ...
    public RawNode serializeIntoRawNode()
    {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("children")) {
          ...
          rawNode.setChildren("entity", entity.stream().map(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity::serializeIntoRawNode).toList());
          return rawNode;
        }
      }
    }
    ...
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity> getEntity()
    {
      return this.entity;
    }
    public java.util.stream.Stream<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity> streamEntity()
    {
      return entity.stream();
    }
    public Entities addEntity(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity value)
    {
      this.entity.add(value);
      value.parentNode(this);
      return this;
    }
    public Entities addAllEntity(List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity> value)
    {
      this.entity.addAll(value);
      value.forEach(e -> e.parentNode(this));
      return this;
    }
    public Entities removeEntity(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity value)
    {
    ...
    public ro.anud.xml_xsd.implementation.util.LinkedNode deserializeAtPath(String xpath, RawNode rawNode) {
       if(xpath.startsWith("."))
        ...
        if(xpath.startsWith(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity.nodeName + "["))
        {
          var startTokens = xpath.split(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity.nodeName + "\\[");
          var endToken = startTokens[1].split("]");
          var indexString = endToken[0];
          var childXPath = xpath.replace(ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity.nodeName + "[" + indexString + "]", "");
          ...
          var newEntry = new ro.anud.xml_xsd.implementation.model.WorldStep.Data.Entities.Entity.Entity();
