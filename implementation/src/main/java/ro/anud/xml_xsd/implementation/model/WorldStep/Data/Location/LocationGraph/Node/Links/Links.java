...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Links  {
    ...
    public static Optional<Links> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Links::fromRawNode));
    }
    public static List<Links> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Links> returnList = rawNodeList.stream().map(Links::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Links> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.linkTo = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.LinkTo.fromRawNode(rawNode.getChildrenList("link_to"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.LinkTo> GetOrInsertDefault_LinkTo()
    {
      if(this.linkTo == null) {
    ...
    */
    public Links setLinkTo(List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.LinkTo> value)
    {
      this.linkTo = value;
