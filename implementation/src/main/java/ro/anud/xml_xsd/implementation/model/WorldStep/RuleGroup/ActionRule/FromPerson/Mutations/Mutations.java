...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Mutations  {
    ...
    public static Optional<Mutations> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Mutations::fromRawNode));
    }
    public static List<Mutations> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Mutations> returnList = rawNodeList.stream().map(Mutations::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Mutations> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.propertyMutation = ro.anud.xml_xsd.implementation.model.Type_propertyMutation.Type_propertyMutation.fromRawNode(rawNode.getChildrenList("property_mutation"));
    }
    ...
    public Mutations setPropertyMutation(List<ro.anud.xml_xsd.implementation.model.Type_propertyMutation.Type_propertyMutation> value)
    {
