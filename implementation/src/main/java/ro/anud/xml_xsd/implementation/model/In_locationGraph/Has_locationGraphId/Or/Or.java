package ro.anud.xml_xsd.implementation.model.In_locationGraph.Has_locationGraphId.Or;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Or implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static Optional<Or> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> Or.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".in__location_graph.has__location_graph_id.or";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Or>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Or>> onRemoveList = new ArrayList<>();
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.In_locationGraph.Has_locationGraphId.Has_locationGraphId> parentAsHas_locationGraphId() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.In_locationGraph.Has_locationGraphId.Has_locationGraphId casted){
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Or> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Or> callback) {
      try (var logger = logScope()) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          var locationGraphIdRefValue = rawNode.getAttribute("location_graph_id_ref");
