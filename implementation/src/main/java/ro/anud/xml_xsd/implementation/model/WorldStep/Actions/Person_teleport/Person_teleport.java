...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Person_teleport  {
    ...
    public static Optional<Person_teleport> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Person_teleport::fromRawNode));
    }
    public static List<Person_teleport> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Person_teleport> returnList = rawNodeList.stream().map(Person_teleport::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Person_teleport> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.locationGraph = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LocationGraph.LocationGraph.fromRawNode(rawNode.getChildrenFirst("location_graph"));
      this.linkTo = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LinkTo.LinkTo.fromRawNode(rawNode.getChildrenFirst("link_to").get());
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("location_graph", locationGraph);
      rawNode.addChildren("link_to", linkTo);
      return rawNode;
    }
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LocationGraph.LocationGraph> GetOrInsertDefault_LocationGraph()
    {
    ...
    */
    public Person_teleport setLocationGraph(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LocationGraph.LocationGraph> value)
    {
      this.locationGraph = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LinkTo.LinkTo GetOrInsertDefault_LinkTo()
    {
      if(this.linkTo == null) {
        this.linkTo = new ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_teleport.LinkTo.LinkTo();
      }
      return this.linkTo;
    }
    */
