package ro.anud.xml_xsd.implementation.model.WorldStep.Data.ZoneList.Zone.Region.Position;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Position implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.data.zone_list.zone.region.position";
    }
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          var rotationValue = rawNode.getAttributeRequired("rotation");
          if(Objects.equals(this.rotation, rotationValue)) {
            isDirty = true;
          }
