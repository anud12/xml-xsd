...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Type_propertyMutation implements  ro.anud.xml_xsd.implementation.model.interfaces.IType_propertyMutation.IType_propertyMutation<Type_propertyMutation>,  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Type_propertyMutation>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Type_propertyMutation>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "type__property_mutation";
    }
    public static Type_propertyMutation of() {
      return new Type_propertyMutation();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Type_propertyMutation> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Type_propertyMutation> callback) {
      try (var logger = logScope()) {
