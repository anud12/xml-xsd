...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class LocationGraph_create  {
    ...
    public static Optional<LocationGraph_create> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LocationGraph_create::fromRawNode));
    }
    public static List<LocationGraph_create> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LocationGraph_create> returnList = rawNodeList.stream().map(LocationGraph_create::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LocationGraph_create> onChange) {
      logEnter();
