...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class LocationGraph_create implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "location_graph.create";
    ...
    public static Optional<LocationGraph_create> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> LocationGraph_create.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.actions.location_graph.create";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationGraph_create>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationGraph_create>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "location_graph.create";
    }
    public static LocationGraph_create of() {
      return new LocationGraph_create();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationGraph_create> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationGraph_create> callback) {
      try (var logger = logScope()) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          var locationGraphRuleRefValue = rawNode.getAttributeRequired("location_graph_rule_ref");
          if(Objects.equals(this.locationGraphRuleRef, locationGraphRuleRefValue)) {
            isDirty = true;
          }
          this.locationGraphRuleRef = locationGraphRuleRefValue;
        }
    ...
    {
      try (var logger = logScope()) {
        rawNode.setTag("location_graph.create");
        try (var innerLogger = logScope("attributes")) {
