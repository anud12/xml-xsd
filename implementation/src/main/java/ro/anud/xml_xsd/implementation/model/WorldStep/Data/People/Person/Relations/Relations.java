...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Relations  {
    ...
    public static Optional<Relations> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Relations::fromRawNode));
    }
    public static List<Relations> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Relations> returnList = rawNodeList.stream().map(Relations::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Relations> onChange) {
