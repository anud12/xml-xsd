...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Node  {
    ...
    public static Optional<Node> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Node::fromRawNode));
    }
    public static List<Node> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Node> returnList = rawNodeList.stream().map(Node::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Node> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.name = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Name.Name.fromRawNode(rawNode.getChildrenFirst("name"));
      this.position = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Position.Position.fromRawNode(rawNode.getChildrenFirst("position"));
      this.classifications = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Classifications.Classifications.fromRawNode(rawNode.getChildrenFirst("classifications"));
      this.links = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.Links.fromRawNode(rawNode.getChildrenFirst("links"));
      this.people = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.People.People.fromRawNode(rawNode.getChildrenFirst("people"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("name", name);
      rawNode.addChildren("position", position);
      rawNode.addChildren("classifications", classifications);
      rawNode.addChildren("links", links);
      rawNode.addChildren("people", people);
      return rawNode;
    }
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Name.Name> GetOrInsertDefault_Name()
    {
      if(this.name == null) {
    ...
    */
    public Node setName(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Name.Name> value)
    {
      this.name = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Position.Position> GetOrInsertDefault_Position()
    {
    ...
    */
    public Node setPosition(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Position.Position> value)
    {
      this.position = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Classifications.Classifications> GetOrInsertDefault_Classifications()
    {
    ...
    */
    public Node setClassifications(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Classifications.Classifications> value)
    {
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.Links> GetOrInsertDefault_Links()
    {
      if(this.links == null) {
    ...
    */
    public Node setLinks(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.Links> value)
    {
      this.links = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.People.People> GetOrInsertDefault_People()
    {
      if(this.people == null) {
    ...
    */
    public Node setPeople(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.People.People> value)
    {
      this.people = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
