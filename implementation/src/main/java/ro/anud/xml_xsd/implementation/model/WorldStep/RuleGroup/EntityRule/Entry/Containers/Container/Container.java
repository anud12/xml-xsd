package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.Containers.Container;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Container implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.rule_group.entity_rule.entry.containers.container";
    }
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.Containers.Containers> parentAsContainers() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.Containers.Containers casted){
