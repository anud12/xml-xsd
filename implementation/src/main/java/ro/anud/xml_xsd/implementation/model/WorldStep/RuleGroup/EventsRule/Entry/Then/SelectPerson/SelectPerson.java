...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class SelectPerson implements  ro.anud.xml_xsd.implementation.model.interfaces.IType_personSelection.IType_personSelection<SelectPerson>,  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<SelectPerson>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<SelectPerson>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "select_person";
    }
    public static SelectPerson of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<SelectPerson> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<SelectPerson> callback) {
      try (var logger = logScope()) {
