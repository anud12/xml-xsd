package ro.anud.xml_xsd.implementation.model.WorldStep.Data.Zone.Region.Position;
...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class Position implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.data.zone.region.position";
    }
    ...
    public void deserialize (RawNode rawNode) {
      try {
        ...
        innerLogger.log("x");
        this.x = rawNode.getAttributeDoubleRequired("x");
        innerLogger.log("y");
        this.y = rawNode.getAttributeDoubleRequired("y");
    ...
    public Position setX(Double value)
    {
      this.x = value;
      notifyChange();
      return this;
    ...
    public Position setY(Double value)
    {
      this.y = value;
      notifyChange();
      return this;
