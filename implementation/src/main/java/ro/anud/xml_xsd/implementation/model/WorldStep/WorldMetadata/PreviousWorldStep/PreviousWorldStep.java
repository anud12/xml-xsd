...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class PreviousWorldStep  {
    ...
    public static Optional<PreviousWorldStep> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(PreviousWorldStep::fromRawNode));
    }
    public static List<PreviousWorldStep> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<PreviousWorldStep> returnList = rawNodeList.stream().map(PreviousWorldStep::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<PreviousWorldStep> onChange) {
      logEnter();
