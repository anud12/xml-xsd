...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class PreviousWorldStep implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "previous_world_step";
    ...
    public static Optional<PreviousWorldStep> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> PreviousWorldStep.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.world_metadata.previous_world_step";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<PreviousWorldStep>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<PreviousWorldStep>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "previous_world_step";
    }
    public static PreviousWorldStep of() {
      return new PreviousWorldStep();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<PreviousWorldStep> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<PreviousWorldStep> callback) {
      try (var logger = logScope()) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          var valueValue = rawNode.getAttribute("value");
    ...
    {
      try (var logger = logScope()) {
        rawNode.setTag("previous_world_step");
        try (var innerLogger = logScope("attributes")) {
