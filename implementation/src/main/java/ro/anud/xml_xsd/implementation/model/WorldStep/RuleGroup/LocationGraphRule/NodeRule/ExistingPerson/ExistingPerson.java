...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class ExistingPerson  {
    ...
    public static Optional<ExistingPerson> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(ExistingPerson::fromRawNode));
    }
    public static List<ExistingPerson> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<ExistingPerson> returnList = rawNodeList.stream().map(ExistingPerson::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<ExistingPerson> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.personSelection = ro.anud.xml_xsd.implementation.model.Type_personSelection.Type_personSelection.fromRawNode(rawNode.getChildrenFirst("person_selection").get());
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("person_selection", personSelection);
      return rawNode;
    }
