...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class PropertyThreshold  {
    ...
    public static Optional<PropertyThreshold> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(PropertyThreshold::fromRawNode));
    }
    public static List<PropertyThreshold> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<PropertyThreshold> returnList = rawNodeList.stream().map(PropertyThreshold::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<PropertyThreshold> onChange) {
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      rawNode.setAttribute("min-value-inclusive", this.minValueInclusive);
      rawNode.setAttribute("max-value-inclusive", this.maxValueInclusive);
