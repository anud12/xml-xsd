...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class Person_onPerson_propertyMutation  {
    ...
    private List<Consumer<Person_onPerson_propertyMutation>> onChangeList = new ArrayList<>();
    ...
    public static Optional<Person_onPerson_propertyMutation> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Person_onPerson_propertyMutation::fromRawNode));
    }
    public static List<Person_onPerson_propertyMutation> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Person_onPerson_propertyMutation> returnList = rawNodeList.stream().map(Person_onPerson_propertyMutation::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Person_onPerson_propertyMutation> onChange) {
