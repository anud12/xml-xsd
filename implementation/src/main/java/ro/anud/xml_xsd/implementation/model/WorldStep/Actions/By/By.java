...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class By  {
    ...
    public static Optional<By> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(By::fromRawNode));
    }
    public static List<By> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<By> returnList = rawNodeList.stream().map(By::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<By> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.doElement = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.DoElement.DoElement.fromRawNode(rawNode.getChildrenFirst("do").get());
      this.moveTowards = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.MoveTowards.MoveTowards.fromRawNode(rawNode.getChildrenFirst("move_towards").get());
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("do", doElement);
      rawNode.addChildren("move_towards", moveTowards);
      return rawNode;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.DoElement.DoElement GetOrInsertDefault_DoElement()
    {
      if(this.doElement == null) {
        this.doElement = new ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.DoElement.DoElement();
      }
      return this.doElement;
    }
    */
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.MoveTowards.MoveTowards GetOrInsertDefault_MoveTowards()
    {
      if(this.moveTowards == null) {
        this.moveTowards = new ro.anud.xml_xsd.implementation.model.WorldStep.Actions.By.MoveTowards.MoveTowards();
      }
      return this.moveTowards;
    }
    */
