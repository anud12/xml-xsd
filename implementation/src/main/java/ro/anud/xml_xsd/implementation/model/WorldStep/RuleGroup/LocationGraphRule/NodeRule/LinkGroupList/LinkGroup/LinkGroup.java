...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LinkGroup  {
    ...
    public static Optional<LinkGroup> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LinkGroup::fromRawNode));
    }
    public static List<LinkGroup> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LinkGroup> returnList = rawNodeList.stream().map(LinkGroup::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LinkGroup> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.toOption = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.ToOption.ToOption.fromRawNode(rawNode.getChildrenList("to_option"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      rawNode.setAttribute("angleMax", this.angleMax);
      rawNode.setAttribute("limit", this.limit);

      //Serialize children
      rawNode.addChildren("to_option", toOption);
      return rawNode;
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.ToOption.ToOption> GetOrInsertDefault_ToOption()
    {
      if(this.toOption == null) {
        this.toOption = new ArrayList<>();
      }
      return this.toOption;
    }
    */
    public LinkGroup setToOption(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.ToOption.ToOption> value)
    {
      this.toOption = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
