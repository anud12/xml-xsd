package ro.anud.xml_xsd.implementation.model.To;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class To implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    //Children elements
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.model.To.Region.Region> region = new ArrayList<>();
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<To>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<To>> onRemoveList = new ArrayList<>();
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<To> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<To> callback) {
      try (var logger = logScope()) {
    ...
    public RawNode serializeIntoRawNode()
    {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("children")) {
          ...
          rawNode.setChildren("region", region.stream().map(ro.anud.xml_xsd.implementation.model.To.Region.Region::serializeIntoRawNode).toList());
          return rawNode;
        }
      }
    }
    ...
    public List<ro.anud.xml_xsd.implementation.model.To.Region.Region> getRegion()
    {
      return this.region;
    }
    public java.util.stream.Stream<ro.anud.xml_xsd.implementation.model.To.Region.Region> streamRegion()
    {
      return region.stream();
    }
    public To addRegion(ro.anud.xml_xsd.implementation.model.To.Region.Region value)
    {
    ...
    public ro.anud.xml_xsd.implementation.util.LinkedNode deserializeAtPath(String xpath, RawNode rawNode) {
       if(xpath.startsWith("."))
        ...
        if(xpath.startsWith(ro.anud.xml_xsd.implementation.model.To.Region.Region.nodeName + "["))
        {
          var startTokens = xpath.split(ro.anud.xml_xsd.implementation.model.To.Region.Region.nodeName + "\\[");
          var endToken = startTokens[1].split("]");
          var indexString = endToken[0];
          var childXPath = xpath.replace(ro.anud.xml_xsd.implementation.model.To.Region.Region.nodeName + "[" + indexString + "]", "");
