...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class LinkGroupRuleList  {
    ...
    public static Optional<LinkGroupRuleList> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LinkGroupRuleList::fromRawNode));
    }
    public static List<LinkGroupRuleList> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LinkGroupRuleList> returnList = rawNodeList.stream().map(LinkGroupRuleList::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LinkGroupRuleList> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.linkGroupRule = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.LinkGroupRule.fromRawNode(rawNode.getChildrenList("link_group_rule"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("link_group_rule", linkGroupRule);
      return rawNode;
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.LinkGroupRule> GetOrInsertDefault_LinkGroupRule()
    {
      if(this.linkGroupRule == null) {
        this.linkGroupRule = new ArrayList<>();
      }
      return this.linkGroupRule;
    }
    */
    public LinkGroupRuleList setLinkGroupRule(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.LinkGroupRule> value)
    {
      this.linkGroupRule = value;
