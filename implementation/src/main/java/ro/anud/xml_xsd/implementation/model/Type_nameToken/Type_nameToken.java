...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Type_nameToken implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static Optional<Type_nameToken> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> Type_nameToken.fromRawNode(o, parent)));
        }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Type_nameToken>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Type_nameToken>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "type__name_token";
    }
    public static Type_nameToken of() {
      return new Type_nameToken();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Type_nameToken> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Type_nameToken> callback) {
      try (var logger = logScope()) {
    ...
    {
      try (var logger = logScope()) {
        rawNode.setTag("type__name_token");
        try (var innerLogger = logScope("attributes")) {
    ...
    public Optional<ro.anud.xml_xsd.implementation.util.LinkedNode> getNodeAtPath(String xpath) {
       if(xpath.startsWith("."))
        ...
        if(xpath.startsWith(ro.anud.xml_xsd.implementation.model.Type_nameToken.NameToken.NameToken.nodeName + "["))
        {
          ...
          var pathIndex = Integer.parseInt(indexString);
          if(this.nameToken.size() > pathIndex) {
            return this.nameToken.get(pathIndex).getNodeAtPath(childXPath);
          }
