...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LocationMutation  {
    ...
    public static Optional<LocationMutation> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LocationMutation::fromRawNode));
    }
    public static List<LocationMutation> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LocationMutation> returnList = rawNodeList.stream().map(LocationMutation::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LocationMutation> onChange) {
      logEnter();
    ...
    public LocationMutation setFrom(List<ro.anud.xml_xsd.implementation.model.Group_mathOperations.Group_mathOperations> value)
    {
      this.from = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
