package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry;
...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class Entry implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static final String TYPE_ID = "/world_step/rule_group/location_classification_rule/entry";
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.LocationClassificationRule> parentAsLocationClassificationRule() {
      return parentNode.flatMap(node -> {
       if (node instanceof ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.LocationClassificationRule casted){
