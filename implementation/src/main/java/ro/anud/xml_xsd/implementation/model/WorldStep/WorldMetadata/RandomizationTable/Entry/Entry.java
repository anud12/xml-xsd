package ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.Entry;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Entry implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.world_metadata.randomization_table.entry";
    }
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.RandomizationTable> parentAsRandomizationTable() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.RandomizationTable casted){
