package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.ActionRule.PersonToPerson.LocationMutation.From;
...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class From implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.ActionRule.PersonToPerson.LocationMutation.LocationMutation> parentAsLocationMutation() {
      return parentNode.flatMap(node -> {
       if (node instanceof ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.ActionRule.PersonToPerson.LocationMutation.LocationMutation casted){
