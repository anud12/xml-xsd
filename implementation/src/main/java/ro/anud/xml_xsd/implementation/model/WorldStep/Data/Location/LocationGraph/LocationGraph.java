...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LocationGraph  {
    ...
    public static Optional<LocationGraph> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LocationGraph::fromRawNode));
    }
    public static List<LocationGraph> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LocationGraph> returnList = rawNodeList.stream().map(LocationGraph::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LocationGraph> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.rule = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Rule.Rule.fromRawNode(rawNode.getChildrenFirst("rule").get());
      this.node = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Node.fromRawNode(rawNode.getChildrenList("node"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("rule", rule);
      rawNode.addChildren("node", node);
      return rawNode;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Rule.Rule GetOrInsertDefault_Rule()
    {
      if(this.rule == null) {
        this.rule = new ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Rule.Rule();
      }
      return this.rule;
    }
    */
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Node> GetOrInsertDefault_Node()
    {
      if(this.node == null) {
    ...
    */
    public LocationGraph setNode(List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Node> value)
    {
      this.node = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
