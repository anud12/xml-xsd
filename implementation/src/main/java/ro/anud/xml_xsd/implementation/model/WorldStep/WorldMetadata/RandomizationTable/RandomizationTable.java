...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class RandomizationTable implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static Optional<RandomizationTable> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> RandomizationTable.fromRawNode(o, parent)));
        }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<RandomizationTable>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<RandomizationTable>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "randomization_table";
    }
    public static RandomizationTable of() {
      return new RandomizationTable();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<RandomizationTable> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<RandomizationTable> callback) {
      try (var logger = logScope()) {
