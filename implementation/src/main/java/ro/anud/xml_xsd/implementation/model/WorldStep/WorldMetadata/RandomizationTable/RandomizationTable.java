...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class RandomizationTable  {
    ...
    public static Optional<RandomizationTable> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(RandomizationTable::fromRawNode));
    }
    public static List<RandomizationTable> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<RandomizationTable> returnList = rawNodeList.stream().map(RandomizationTable::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<RandomizationTable> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.entry = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.Entry.Entry.fromRawNode(rawNode.getChildrenList("entry"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.Entry.Entry> GetOrInsertDefault_Entry()
    {
      if(this.entry == null) {
    ...
    */
    public RandomizationTable setEntry(List<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.Entry.Entry> value)
    {
      this.entry = value;
