...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class WorldStep  {
    ...
    public static Optional<WorldStep> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(WorldStep::fromRawNode));
    }
    public static List<WorldStep> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<WorldStep> returnList = rawNodeList.stream().map(WorldStep::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<WorldStep> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.worldMetadata = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.WorldMetadata.fromRawNode(rawNode.getChildrenFirst("world_metadata").get());
      this.ruleGroup = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RuleGroup.fromRawNode(rawNode.getChildrenList("rule_group"));
      this.data = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Data.fromRawNode(rawNode.getChildrenFirst("data").get());
      this.actions = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Actions.fromRawNode(rawNode.getChildrenFirst("actions"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("world_metadata", worldMetadata);
      rawNode.addChildren("rule_group", ruleGroup);
      rawNode.addChildren("data", data);
      rawNode.addChildren("actions", actions);
      return rawNode;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.WorldMetadata GetOrInsertDefault_WorldMetadata()
    {
      if(this.worldMetadata == null) {
        this.worldMetadata = new ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.WorldMetadata();
      }
      return this.worldMetadata;
    }
    */
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RuleGroup> GetOrInsertDefault_RuleGroup()
    {
    ...
    */
    public WorldStep setRuleGroup(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RuleGroup> value)
    {
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.Data.Data GetOrInsertDefault_Data()
    {
      if(this.data == null) {
        this.data = new ro.anud.xml_xsd.implementation.model.WorldStep.Data.Data();
      }
      return this.data;
    }
    */
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Actions> GetOrInsertDefault_Actions()
    {
    ...
    */
    public WorldStep setActions(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Actions> value)
    {
      this.actions = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
