package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.ToOption;
...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class ToOption  {
    ...
    public static Optional<ToOption> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(ToOption::fromRawNode));
    }
    public static List<ToOption> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<ToOption> returnList = rawNodeList.stream().map(ToOption::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<ToOption> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.distanceToProgressMultiplier = ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations.fromRawNode(rawNode.getChildrenFirst("distance_to_progress_multiplier"));
      this.personProgressProperty = ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations.fromRawNode(rawNode.getChildrenFirst("person_progress_property"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      rawNode.setAttribute("maxDistance", this.maxDistance);
      rawNode.setAttribute("adjacent_depth_limit", this.adjacentDepthLimit);

      //Serialize children
      rawNode.addChildren("distance_to_progress_multiplier", distanceToProgressMultiplier);
      rawNode.addChildren("person_progress_property", personProgressProperty);
      return rawNode;
    }
    ...
    public ToOption setDistanceToProgressMultiplier(Optional<ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations> value)
    {
      this.distanceToProgressMultiplier = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
    ...
    public ToOption setPersonProgressProperty(Optional<ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations> value)
    {
      this.personProgressProperty = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
