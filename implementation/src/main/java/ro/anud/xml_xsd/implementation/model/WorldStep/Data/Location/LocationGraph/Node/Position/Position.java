...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Position  {
    ...
    public static Optional<Position> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Position::fromRawNode));
    }
    public static List<Position> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Position> returnList = rawNodeList.stream().map(Position::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Position> onChange) {
      logEnter();
