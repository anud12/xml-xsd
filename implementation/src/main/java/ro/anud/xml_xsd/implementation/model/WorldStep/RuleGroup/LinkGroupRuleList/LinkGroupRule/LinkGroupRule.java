...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LinkGroupRule  {
    ...
    public static Optional<LinkGroupRule> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LinkGroupRule::fromRawNode));
    }
    public static List<LinkGroupRule> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LinkGroupRule> returnList = rawNodeList.stream().map(LinkGroupRule::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LinkGroupRule> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.toOption = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.ToOption.ToOption.fromRawNode(rawNode.getChildrenList("to_option"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.ToOption.ToOption> GetOrInsertDefault_ToOption()
    {
    ...
    */
    public LinkGroupRule setToOption(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LinkGroupRuleList.LinkGroupRule.ToOption.ToOption> value)
    {
      this.toOption = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
