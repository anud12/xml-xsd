...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class ItemDefault implements ro.anud.xml_xsd.implementation.model.interfaces.IType_mathOperations.IType_mathOperations<ItemDefault> {
    ...
    private List<Consumer<ItemDefault>> onChangeList = new ArrayList<>();
    ...
    public static Optional<ItemDefault> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(ItemDefault::fromRawNode));
    }
    public static List<ItemDefault> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<ItemDefault> returnList = rawNodeList.stream().map(ItemDefault::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<ItemDefault> onChange) {
      logEnter();
...
rawNode.setAttribute("initial", this.initial);
    ...
    public ItemDefault setInitial(Integer value)
    {
      this.initial = value;
