...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class ItemDefault implements  ro.anud.xml_xsd.implementation.model.interfaces.IType_mathOperations.IType_mathOperations<ItemDefault>,  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<ItemDefault>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<ItemDefault>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "item_default";
    }
    public static ItemDefault of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<ItemDefault> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<ItemDefault> callback) {
      try (var logger = logScope()) {
