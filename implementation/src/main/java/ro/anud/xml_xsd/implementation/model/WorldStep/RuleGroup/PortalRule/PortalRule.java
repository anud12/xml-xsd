...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class PortalRule implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<PortalRule>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<PortalRule>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "portal_rule";
    }
    public static PortalRule of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<PortalRule> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<PortalRule> callback) {
      try (var logger = logScope()) {
