package ro.anud.xml_xsd.implementation.model.Containers.Container.Entities.Entity;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Entity implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".containers.container.entities.entity";
    }
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.Containers.Container.Entities.Entities> parentAsEntities() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.Containers.Container.Entities.Entities casted){
