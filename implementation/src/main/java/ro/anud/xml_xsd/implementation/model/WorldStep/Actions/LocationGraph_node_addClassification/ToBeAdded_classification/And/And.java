...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class And  {
    ...
    public static Optional<And> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(And::fromRawNode));
    }
    public static List<And> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<And> returnList = rawNodeList.stream().map(And::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<And> onChange) {
      logEnter();
