...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Person_moveTo implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Person_moveTo>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Person_moveTo>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "person.move_to";
    }
    public static Person_moveTo of() {
      return new Person_moveTo();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Person_moveTo> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Person_moveTo> callback) {
      try (var logger = logScope()) {
