...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Person_moveTo  {
    ...
    public static Optional<Person_moveTo> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Person_moveTo::fromRawNode));
    }
    public static List<Person_moveTo> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Person_moveTo> returnList = rawNodeList.stream().map(Person_moveTo::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Person_moveTo> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.findPathTowards = ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.Type_nodeGraph_selection.fromRawNode(rawNode.getChildrenFirst("find_path_towards"));
      this.path = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_moveTo.Path.Path.fromRawNode(rawNode.getChildrenFirst("path"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("find_path_towards", findPathTowards);
      rawNode.addChildren("path", path);
      return rawNode;
    }
    ...
    public Person_moveTo setFindPathTowards(Optional<ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.Type_nodeGraph_selection> value)
    {
      this.findPathTowards = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_moveTo.Path.Path> GetOrInsertDefault_Path()
    {
      if(this.path == null) {
    ...
    */
    public Person_moveTo setPath(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.Person_moveTo.Path.Path> value)
    {
      this.path = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
