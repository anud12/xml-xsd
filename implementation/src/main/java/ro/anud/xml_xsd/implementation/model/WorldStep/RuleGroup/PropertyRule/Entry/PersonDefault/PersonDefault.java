...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class PersonDefault implements ro.anud.xml_xsd.implementation.model.interfaces.IType_mathOperations.IType_mathOperations<PersonDefault> {
    ...
    public static Optional<PersonDefault> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(PersonDefault::fromRawNode));
    }
    public static List<PersonDefault> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<PersonDefault> returnList = rawNodeList.stream().map(PersonDefault::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<PersonDefault> onChange) {
      logEnter();
...
rawNode.setAttribute("initial", this.initial);
    ...
    public PersonDefault setInitial(Integer value)
    {
      this.initial = value;
