...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class PropertyRule implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static Optional<PropertyRule> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> PropertyRule.fromRawNode(o, parent)));
        }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<PropertyRule>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<PropertyRule>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "property_rule";
    }
    public static PropertyRule of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<PropertyRule> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<PropertyRule> callback) {
      try (var logger = logScope()) {
