...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class PropertyRule  {
    ...
    public static Optional<PropertyRule> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(PropertyRule::fromRawNode));
    }
    public static List<PropertyRule> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<PropertyRule> returnList = rawNodeList.stream().map(PropertyRule::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<PropertyRule> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.entry = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.PropertyRule.Entry.Entry.fromRawNode(rawNode.getChildrenList("entry"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.PropertyRule.Entry.Entry> GetOrInsertDefault_Entry()
    {
      if(this.entry == null) {
    ...
    */
    public PropertyRule setEntry(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.PropertyRule.Entry.Entry> value)
    {
      this.entry = value;
