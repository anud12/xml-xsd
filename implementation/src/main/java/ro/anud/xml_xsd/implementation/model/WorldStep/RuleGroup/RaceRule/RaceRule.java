...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class RaceRule  {
    ...
    private List<Consumer<RaceRule>> onChangeList = new ArrayList<>();
    ...
    public static Optional<RaceRule> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(RaceRule::fromRawNode));
    }
    public static List<RaceRule> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<RaceRule> returnList = rawNodeList.stream().map(RaceRule::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<RaceRule> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.entry = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RaceRule.Entry.Entry.fromRawNode(rawNode.getChildrenList("entry"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RaceRule.Entry.Entry> GetOrInsertDefault_Entry()
    {
      if(this.entry == null) {
    ...
    */
    public RaceRule setEntry(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RaceRule.Entry.Entry> value)
    {
      this.entry = value;
