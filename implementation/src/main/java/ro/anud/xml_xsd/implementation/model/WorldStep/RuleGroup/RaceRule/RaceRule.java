...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class RaceRule implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public Subscription onChange(Consumer<RaceRule> onChange) {
      logEnter();
    ...
    public Stream<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.RaceRule.Entry.Entry> streamEntry()
    {
      return entry.stream();
    }
