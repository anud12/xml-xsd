...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class People  {
    ...
    public static Optional<People> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(People::fromRawNode));
    }
    public static List<People> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<People> returnList = rawNodeList.stream().map(People::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<People> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.person = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.Person.Person.fromRawNode(rawNode.getChildrenList("person"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.Person.Person> GetOrInsertDefault_Person()
    {
      if(this.person == null) {
    ...
    */
    public People setPerson(List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.Person.Person> value)
    {
      this.person = value;
