...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Name  {
    ...
    public static Optional<Name> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Name::fromRawNode));
    }
    public static List<Name> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Name> returnList = rawNodeList.stream().map(Name::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Name> onChange) {
      logEnter();
