...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LinkTo  {
    ...
    public static Optional<LinkTo> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LinkTo::fromRawNode));
    }
    public static List<LinkTo> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LinkTo> returnList = rawNodeList.stream().map(LinkTo::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LinkTo> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.people = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.People.fromRawNode(rawNode.getChildrenFirst("people"));
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.People> GetOrInsertDefault_People()
    {
      if(this.people == null) {
    ...
    */
    public LinkTo setPeople(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.Node.Links.LinkTo.People.People> value)
    {
      this.people = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    ...
    public LinkTo setPersonProgressProperty(Optional<ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations> value)
    {
