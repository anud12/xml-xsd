...
public class GetProperty {
    ...
    public static Optional<Integer> computeBaseProperty(
        ...
        try (var logger = logScope("propertyRef:", propertyRef)){
    ...
    private static Optional<Mutation<Integer>> getBaseProperty(
        ...
        final Person person,
        final String propertyRef) {
        try (var logger = logScope("personId:", person.getId(), "propertyRef:", propertyRef)){
            var value = computeBaseProperty(worldStepInstance,person,propertyRef);
            try (var innerLog = logScope("computed value", value)){
