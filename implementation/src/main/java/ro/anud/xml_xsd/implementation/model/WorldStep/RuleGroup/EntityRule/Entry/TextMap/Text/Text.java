package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.TextMap.Text;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Text implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".world_step.rule_group.entity_rule.entry.text_map.text";
    }
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.TextMap.TextMap> parentAsTextMap() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.EntityRule.Entry.TextMap.TextMap casted){
