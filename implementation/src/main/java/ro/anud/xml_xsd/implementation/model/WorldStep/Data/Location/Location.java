...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Location  {
    ...
    public static Optional<Location> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Location::fromRawNode));
    }
    public static List<Location> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Location> returnList = rawNodeList.stream().map(Location::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Location> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.locationGraph = ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.LocationGraph.fromRawNode(rawNode.getChildrenList("location_graph"));
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.LocationGraph> GetOrInsertDefault_LocationGraph()
    {
      if(this.locationGraph == null) {
        this.locationGraph = new ArrayList<>();
      }
      return this.locationGraph;
    }
    */
    public Location setLocationGraph(List<ro.anud.xml_xsd.implementation.model.WorldStep.Data.Location.LocationGraph.LocationGraph> value)
    {
