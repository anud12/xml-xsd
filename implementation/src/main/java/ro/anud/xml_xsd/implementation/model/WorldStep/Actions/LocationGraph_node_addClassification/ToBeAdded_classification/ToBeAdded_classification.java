...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class ToBeAdded_classification  {
    ...
    private List<Consumer<ToBeAdded_classification>> onChangeList = new ArrayList<>();
    ...
    public static Optional<ToBeAdded_classification> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(ToBeAdded_classification::fromRawNode));
    }
    public static List<ToBeAdded_classification> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<ToBeAdded_classification> returnList = rawNodeList.stream().map(ToBeAdded_classification::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<ToBeAdded_classification> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.and = ro.anud.xml_xsd.implementation.model.WorldStep.Actions.LocationGraph_node_addClassification.ToBeAdded_classification.And.And.fromRawNode(rawNode.getChildrenFirst("and"));
    }
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.LocationGraph_node_addClassification.ToBeAdded_classification.And.And> GetOrInsertDefault_And()
    {
      if(this.and == null) {
    ...
    */
    public ToBeAdded_classification setAnd(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.Actions.LocationGraph_node_addClassification.ToBeAdded_classification.And.And> value)
    {
      this.and = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
