...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Type_nodeGraph_selection implements  ro.anud.xml_xsd.implementation.model.interfaces.IType_nodeGraph_selection.IType_nodeGraph_selection<Type_nodeGraph_selection>,  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.setChildren("in__location_graph", in_locationGraph.stream().map(o -> o.serializeIntoRawNode()).toList());
      rawNode.setChildren("has__node_graph_id", has_nodeGraphId.stream().map(o -> o.serializeIntoRawNode()).toList());
      return rawNode;
    }
