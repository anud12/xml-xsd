...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Type_nodeGraph_selection  {
    ...
    public Runnable onChange(Consumer<Type_nodeGraph_selection> onChange) {
      logEnter();
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.In_locationGraph.In_locationGraph> GetOrInsertDefault_In_locationGraph()
    {
      if(this.in_locationGraph == null) {
        this.in_locationGraph = Optional.empty();
      }
      return this.in_locationGraph;
    }
    */
    public Type_nodeGraph_selection setIn_locationGraph(Optional<ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.In_locationGraph.In_locationGraph> value)
    {
      this.in_locationGraph = value;
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.Has_nodeGraphId.Has_nodeGraphId> GetOrInsertDefault_Has_nodeGraphId()
    {
      if(this.has_nodeGraphId == null) {
        this.has_nodeGraphId = Optional.empty();
      }
      return this.has_nodeGraphId;
    }
    */
    public Type_nodeGraph_selection setHas_nodeGraphId(Optional<ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.Has_nodeGraphId.Has_nodeGraphId> value)
    {
      this.has_nodeGraphId = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
