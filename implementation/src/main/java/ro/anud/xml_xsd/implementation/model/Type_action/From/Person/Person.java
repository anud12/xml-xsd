package ro.anud.xml_xsd.implementation.model.Type_action.From.Person;
...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class Person implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static final String TYPE_ID = "/type__action/from/person";
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.Type_action.From.From> parentAsFrom() {
      return parentNode.flatMap(node -> {
       if (node instanceof ro.anud.xml_xsd.implementation.model.Type_action.From.From casted){
