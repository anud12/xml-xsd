...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class LocationGraph_node_createAdjacent implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationGraph_node_createAdjacent>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationGraph_node_createAdjacent>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "location_graph.node.create_adjacent";
    }
    public static LocationGraph_node_createAdjacent of() {
      return new LocationGraph_node_createAdjacent();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationGraph_node_createAdjacent> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationGraph_node_createAdjacent> callback) {
      try (var logger = logScope()) {
