...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class LocationGraph_node_createAdjacent  {
    ...
    public static Optional<LocationGraph_node_createAdjacent> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LocationGraph_node_createAdjacent::fromRawNode));
    }
    public static List<LocationGraph_node_createAdjacent> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LocationGraph_node_createAdjacent> returnList = rawNodeList.stream().map(LocationGraph_node_createAdjacent::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LocationGraph_node_createAdjacent> onChange) {
      logEnter();
