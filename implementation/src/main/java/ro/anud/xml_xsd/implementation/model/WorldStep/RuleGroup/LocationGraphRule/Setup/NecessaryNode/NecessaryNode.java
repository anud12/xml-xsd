...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class NecessaryNode implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public Subscription onChange(Consumer<NecessaryNode> onChange) {
      logEnter();
    ...
    public Stream<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.Or.Or> streamOr()
    {
      return or.stream();
    }
