...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class NecessaryNode  {
    ...
    private List<Consumer<NecessaryNode>> onChangeList = new ArrayList<>();
    ...
    public static Optional<NecessaryNode> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(NecessaryNode::fromRawNode));
    }
    public static List<NecessaryNode> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<NecessaryNode> returnList = rawNodeList.stream().map(NecessaryNode::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<NecessaryNode> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.or = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.Or.Or.fromRawNode(rawNode.getChildrenList("or"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      rawNode.setAttribute("max", this.max);
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.Or.Or> GetOrInsertDefault_Or()
    {
      if(this.or == null) {
    ...
    */
    public NecessaryNode setOr(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.Or.Or> value)
    {
      this.or = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
