package ro.anud.xml_xsd.implementation.model.Type_entityRule.Containers.Container;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Container implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public String classTypeId() {
      return ".type__entity_rule.containers.container";
    }
    ...
    public Optional<ro.anud.xml_xsd.implementation.model.Type_entityRule.Containers.Containers> parentAsContainers() {
      return parentNode.flatMap(node -> {
        if (node instanceof ro.anud.xml_xsd.implementation.model.Type_entityRule.Containers.Containers casted){
