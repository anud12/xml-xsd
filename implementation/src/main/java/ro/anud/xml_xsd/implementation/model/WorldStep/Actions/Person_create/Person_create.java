...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Person_create  {
    ...
    public static Optional<Person_create> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Person_create::fromRawNode));
    }
    public static List<Person_create> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Person_create> returnList = rawNodeList.stream().map(Person_create::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Person_create> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.nodeGraph_selection = ro.anud.xml_xsd.implementation.model.Type_nodeGraph_selection.Type_nodeGraph_selection.fromRawNode(rawNode.getChildrenFirst("node_graph__selection").get());
      this.person_selection = ro.anud.xml_xsd.implementation.model.Type_personSelection.Type_personSelection.fromRawNode(rawNode.getChildrenFirst("person__selection").get());
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("node_graph__selection", nodeGraph_selection);
      rawNode.addChildren("person__selection", person_selection);
      return rawNode;
    }
