...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class NextWorldStep  {
    ...
    private List<Consumer<NextWorldStep>> onChangeList = new ArrayList<>();
    ...
    public static Optional<NextWorldStep> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(NextWorldStep::fromRawNode));
    }
    public static List<NextWorldStep> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<NextWorldStep> returnList = rawNodeList.stream().map(NextWorldStep::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<NextWorldStep> onChange) {
