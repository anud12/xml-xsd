...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Setup  {
    ...
    private List<Consumer<Setup>> onChangeList = new ArrayList<>();
    ...
    public static Optional<Setup> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Setup::fromRawNode));
    }
    public static List<Setup> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Setup> returnList = rawNodeList.stream().map(Setup::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Setup> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.startingNode = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.StartingNode.StartingNode.fromRawNode(rawNode.getChildrenFirst("starting_node").get());
      this.necessaryNode = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.NecessaryNode.fromRawNode(rawNode.getChildrenList("necessary_node"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("starting_node", startingNode);
      rawNode.addChildren("necessary_node", necessaryNode);
      return rawNode;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.StartingNode.StartingNode GetOrInsertDefault_StartingNode()
    {
      if(this.startingNode == null) {
        this.startingNode = new ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.StartingNode.StartingNode();
      }
      return this.startingNode;
    }
    */
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.NecessaryNode> GetOrInsertDefault_NecessaryNode()
    {
      if(this.necessaryNode == null) {
        this.necessaryNode = new ArrayList<>();
      }
      return this.necessaryNode;
    }
    */
    public Setup setNecessaryNode(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.NecessaryNode> value)
    {
      this.necessaryNode = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
