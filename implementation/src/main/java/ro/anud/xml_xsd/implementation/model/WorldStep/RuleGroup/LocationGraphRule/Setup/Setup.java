...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturnVoid;
  ...
  public class Setup implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public Subscription onChange(Consumer<Setup> onChange) {
      logEnter();
    ...
    public Stream<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.StartingNode.StartingNode> streamStartingNode()
    {
    ...
    public Stream<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.Setup.NecessaryNode.NecessaryNode> streamNecessaryNode()
    {
