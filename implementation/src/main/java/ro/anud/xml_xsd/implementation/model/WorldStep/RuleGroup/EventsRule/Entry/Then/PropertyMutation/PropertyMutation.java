...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class PropertyMutation implements ro.anud.xml_xsd.implementation.model.interfaces.IType_mathOperations.IType_mathOperations<PropertyMutation> {
    ...
    public static Optional<PropertyMutation> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(PropertyMutation::fromRawNode));
    }
    public static List<PropertyMutation> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<PropertyMutation> returnList = rawNodeList.stream().map(PropertyMutation::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<PropertyMutation> onChange) {
      logEnter();
...
rawNode.setAttribute("initial", this.initial);
    ...
    public PropertyMutation setInitial(Integer value)
    {
      this.initial = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
