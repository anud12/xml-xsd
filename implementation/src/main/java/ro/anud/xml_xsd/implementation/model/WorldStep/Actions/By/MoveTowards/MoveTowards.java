...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class MoveTowards  {
    ...
    public static Optional<MoveTowards> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(MoveTowards::fromRawNode));
    }
    public static List<MoveTowards> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<MoveTowards> returnList = rawNodeList.stream().map(MoveTowards::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<MoveTowards> onChange) {
    ...
    {
      //Serialize arguments
      rawNode.setAttribute("layer", this.layer);
