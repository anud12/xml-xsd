...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class MoveTowards implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<MoveTowards>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<MoveTowards>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "move_towards";
    }
    public static MoveTowards of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<MoveTowards> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<MoveTowards> callback) {
      try (var logger = logScope()) {
