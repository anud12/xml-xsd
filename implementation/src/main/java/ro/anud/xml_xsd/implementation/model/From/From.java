...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class From  {
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.From.Person.Person> GetOrInsertDefault_Person()
    {
      if(this.person == null) {
    ...
    */
    public From setPerson(Optional<ro.anud.xml_xsd.implementation.model.From.Person.Person> value)
    {
      this.person = value;
