...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class LocationClassificationRule implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "location_classification_rule";
    ...
    public static Optional<LocationClassificationRule> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> LocationClassificationRule.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.rule_group.location_classification_rule";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationClassificationRule>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationClassificationRule>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "location_classification_rule";
    }
    public static LocationClassificationRule of() {
      return new LocationClassificationRule();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<LocationClassificationRule> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<LocationClassificationRule> callback) {
      try (var logger = logScope()) {
    ...
    {
      try (var logger = logScope()) {
        rawNode.setTag("location_classification_rule");
        try (var innerLogger = logScope("attributes")) {
    ...
    public java.util.stream.Stream<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry.Entry> streamEntry()
    {
      return entry.stream();
    }
    ...
    public ro.anud.xml_xsd.implementation.util.LinkedNode deserializeAtPath(String xpath, RawNode rawNode) {
       if(xpath.startsWith("."))
        ...
        if(xpath.startsWith(ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry.Entry.nodeName + "["))
        {
          var startTokens = xpath.split(ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry.Entry.nodeName + "\\[");
          var endToken = startTokens[1].split("]");
          var indexString = endToken[0];
          var childXPath = xpath.replace(ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry.Entry.nodeName + "[" + indexString + "]", "");
          ...
          var newEntry = new ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationClassificationRule.Entry.Entry();
