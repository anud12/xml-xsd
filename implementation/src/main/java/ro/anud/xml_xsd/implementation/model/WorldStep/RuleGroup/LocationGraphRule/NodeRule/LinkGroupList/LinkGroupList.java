...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class LinkGroupList  {
    ...
    public static Optional<LinkGroupList> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(LinkGroupList::fromRawNode));
    }
    public static List<LinkGroupList> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<LinkGroupList> returnList = rawNodeList.stream().map(LinkGroupList::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<LinkGroupList> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.reference = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.Reference.Reference.fromRawNode(rawNode.getChildrenList("reference"));
      this.linkGroup = ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.LinkGroup.fromRawNode(rawNode.getChildrenList("link_group"));
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("reference", reference);
      rawNode.addChildren("link_group", linkGroup);
      return rawNode;
    }
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.Reference.Reference> GetOrInsertDefault_Reference()
    {
    ...
    */
    public LinkGroupList setReference(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.Reference.Reference> value)
    {
    ...
    /*
    public List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.LinkGroup> GetOrInsertDefault_LinkGroup()
    {
      if(this.linkGroup == null) {
        this.linkGroup = new ArrayList<>();
      }
      return this.linkGroup;
    }
    */
    public LinkGroupList setLinkGroup(List<ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.LocationGraphRule.NodeRule.LinkGroupList.LinkGroup.LinkGroup> value)
    {
