...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class ElapsedTime implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "elapsed_time";
    ...
    public static Optional<ElapsedTime> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> ElapsedTime.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.world_metadata.elapsed_time";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<ElapsedTime>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<ElapsedTime>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "elapsed_time";
    }
    public static ElapsedTime of() {
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<ElapsedTime> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<ElapsedTime> callback) {
      try (var logger = logScope()) {
