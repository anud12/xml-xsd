...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class ElapsedTime  {
    ...
    public static Optional<ElapsedTime> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(ElapsedTime::fromRawNode));
    }
    public static List<ElapsedTime> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<ElapsedTime> returnList = rawNodeList.stream().map(ElapsedTime::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<ElapsedTime> onChange) {
      logEnter();
