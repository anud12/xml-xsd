package ro.anud.xml_xsd.implementation.model.WorldStep.RuleGroup.NodeRule.Area;
...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Area implements  ro.anud.xml_xsd.implementation.util.LinkedNode {

    public static String nodeName = "area";
    public static Area fromRawNode(RawNode rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
    ...
    public static Area fromRawNode(RawNode rawNode) {
      try (var logger = logScope()) {
        var instance = fromRawNode(rawNode, null);
        return logger.logReturn(instance);
      }
    }
    public static Optional<Area> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> Area.fromRawNode(o, parent)));
        }

    }
    public static List<Area> fromRawNode(List<RawNode> rawNodeList, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
      try (var logger = logScope()) {
        List<Area> returnList = Optional.ofNullable(rawNodeList)
            .orElse(List.of())
            .stream()
            .map(o -> Area.fromRawNode(o, parent))
    ...
    public String classTypeId() {
      return ".world_step.rule_group.node_rule.area";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Area>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Area>> onRemoveList = new ArrayList<>();
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Area> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Area> callback) {
      try (var logger = logScope()) {
    ...
    public Area setHeight(ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations value)
    {
      this.height = value;
    ...
    public Area setWidth(ro.anud.xml_xsd.implementation.model.Type_mathOperations.Type_mathOperations value)
    {
      this.width = value;
      value.parentNode(this);
      notifyChange();
