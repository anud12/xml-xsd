...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  @AllArgsConstructor
  @NoArgsConstructor
  public class FromPersonSameLocationGraphNode  {
    ...
    public static Optional<FromPersonSameLocationGraphNode> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(FromPersonSameLocationGraphNode::fromRawNode));
    }
    public static List<FromPersonSameLocationGraphNode> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<FromPersonSameLocationGraphNode> returnList = rawNodeList.stream().map(FromPersonSameLocationGraphNode::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<FromPersonSameLocationGraphNode> onChange) {
      logEnter();
