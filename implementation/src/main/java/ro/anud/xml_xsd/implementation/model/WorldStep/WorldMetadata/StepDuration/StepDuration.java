...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class StepDuration  {
    ...
    public static Optional<StepDuration> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(StepDuration::fromRawNode));
    }
    public static List<StepDuration> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<StepDuration> returnList = rawNodeList.stream().map(StepDuration::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<StepDuration> onChange) {
