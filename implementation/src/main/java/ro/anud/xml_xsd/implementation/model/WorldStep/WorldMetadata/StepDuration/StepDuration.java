...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class StepDuration implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "stepDuration";
    ...
    public static Optional<StepDuration> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> StepDuration.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.world_metadata.stepDuration";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<StepDuration>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<StepDuration>> onRemoveList = new ArrayList<>();

    public String nodeName() {
      return "stepDuration";
    }
    public static StepDuration of() {
      return new StepDuration();
    }
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<StepDuration> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<StepDuration> callback) {
      try (var logger = logScope()) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          var valueValue = rawNode.getAttributeIntRequired("value");
