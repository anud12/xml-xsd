...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Reference implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    public static String nodeName = "reference";
    ...
    public static Optional<Reference> fromRawNode(Optional<RawNode> rawNode, ro.anud.xml_xsd.implementation.util.LinkedNode parent) {
        try(var logger = logScope()) {
          return logger.logReturn(rawNode.map(o -> Reference.fromRawNode(o, parent)));
        }
    ...
    public String classTypeId() {
      return ".world_step.rule_group.location_graph_rule.node_rule.link_group_list.reference";
    }
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Reference>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Reference>> onRemoveList = new ArrayList<>();
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Reference> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Reference> callback) {
      try (var logger = logScope()) {
    ...
    public void deserialize (RawNode rawNode) {
      try (var logger = logScope()) {
        ...
        try (var innerLogger = logScope("attributes")) {
          ...
          innerLogger.log("link_group_rule_ref");
          var linkGroupRuleRefValue = rawNode.getAttributeRequired("link_group_rule_ref");
          if(Objects.equals(this.linkGroupRuleRef, linkGroupRuleRefValue)) {
            isDirty = true;
          }
          this.linkGroupRuleRef = linkGroupRuleRefValue;
        }
