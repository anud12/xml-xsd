...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Reference  {
    ...
    public static Optional<Reference> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Reference::fromRawNode));
    }
    public static List<Reference> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Reference> returnList = rawNodeList.stream().map(Reference::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Reference> onChange) {
      logEnter();
