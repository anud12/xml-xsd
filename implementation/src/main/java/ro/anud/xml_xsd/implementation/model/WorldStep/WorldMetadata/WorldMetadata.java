...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class WorldMetadata  {
    ...
    public static Optional<WorldMetadata> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(WorldMetadata::fromRawNode));
    }
    public static List<WorldMetadata> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<WorldMetadata> returnList = rawNodeList.stream().map(WorldMetadata::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<WorldMetadata> onChange) {
      logEnter();
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.previousWorldStep = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.PreviousWorldStep.PreviousWorldStep.fromRawNode(rawNode.getChildrenFirst("previous_world_step"));
      this.nextWorldStep = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.NextWorldStep.NextWorldStep.fromRawNode(rawNode.getChildrenFirst("next_world_step"));
      this.elapsedTime = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.ElapsedTime.ElapsedTime.fromRawNode(rawNode.getChildrenFirst("elapsed_time").get());
      this.stepDuration = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.StepDuration.StepDuration.fromRawNode(rawNode.getChildrenFirst("stepDuration").get());
      this.counter = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.Counter.Counter.fromRawNode(rawNode.getChildrenFirst("counter").get());
      this.randomizationTable = ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.RandomizationTable.fromRawNode(rawNode.getChildrenFirst("randomization_table").get());
    }
    ...
    public RawNode serializeIntoRawNode()
    {
      ...
      //Serialize children
      rawNode.addChildren("previous_world_step", previousWorldStep);
      rawNode.addChildren("next_world_step", nextWorldStep);
      rawNode.addChildren("elapsed_time", elapsedTime);
      rawNode.addChildren("stepDuration", stepDuration);
      rawNode.addChildren("counter", counter);
      rawNode.addChildren("randomization_table", randomizationTable);
      return rawNode;
    }
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.PreviousWorldStep.PreviousWorldStep> GetOrInsertDefault_PreviousWorldStep()
    {
      if(this.previousWorldStep == null) {
        this.previousWorldStep = Optional.empty();
      }
      return this.previousWorldStep;
    }
    */
    public WorldMetadata setPreviousWorldStep(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.PreviousWorldStep.PreviousWorldStep> value)
    {
      this.previousWorldStep = value;
    ...
    /*
    public Optional<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.NextWorldStep.NextWorldStep> GetOrInsertDefault_NextWorldStep()
    {
      if(this.nextWorldStep == null) {
        this.nextWorldStep = Optional.empty();
      }
      return this.nextWorldStep;
    }
    */
    public WorldMetadata setNextWorldStep(Optional<ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.NextWorldStep.NextWorldStep> value)
    {
      this.nextWorldStep = value;
      onChangeList.forEach(consumer -> consumer.accept(this));
      return this;
    }
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.ElapsedTime.ElapsedTime GetOrInsertDefault_ElapsedTime()
    {
      if(this.elapsedTime == null) {
        this.elapsedTime = new ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.ElapsedTime.ElapsedTime();
      }
      return this.elapsedTime;
    }
    */
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.StepDuration.StepDuration GetOrInsertDefault_StepDuration()
    {
      if(this.stepDuration == null) {
        this.stepDuration = new ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.StepDuration.StepDuration();
      }
      return this.stepDuration;
    }
    */
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.Counter.Counter GetOrInsertDefault_Counter()
    {
      if(this.counter == null) {
        this.counter = new ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.Counter.Counter();
      }
      return this.counter;
    }
    */
    ...
    /*
    public ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.RandomizationTable GetOrInsertDefault_RandomizationTable()
    {
      if(this.randomizationTable == null) {
        this.randomizationTable = new ro.anud.xml_xsd.implementation.model.WorldStep.WorldMetadata.RandomizationTable.RandomizationTable();
      }
      return this.randomizationTable;
    }
    */
