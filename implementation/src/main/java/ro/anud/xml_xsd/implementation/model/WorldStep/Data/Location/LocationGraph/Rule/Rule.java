...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class Rule  {
    ...
    public static Optional<Rule> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(Rule::fromRawNode));
    }
    public static List<Rule> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<Rule> returnList = rawNodeList.stream().map(Rule::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<Rule> onChange) {
      logEnter();
