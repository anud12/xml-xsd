...
import static ro.anud.xml_xsd.implementation.util.logging.LogScope.logScope;
  ...
  public class Rule implements  ro.anud.xml_xsd.implementation.util.LinkedNode {
    ...
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.ChangeCallback<Rule>> onChangeList = new ArrayList<>();
    @Builder.Default
    private List<ro.anud.xml_xsd.implementation.util.RemoveCallback<Rule>> onRemoveList = new ArrayList<>();
    ...
    public Subscription onChange(ro.anud.xml_xsd.implementation.util.ChangeCallback<Rule> callback) {
      try (var logger = logScope()) {
        onChangeList.add(callback);
        return logger.logReturn(() -> onChangeList.remove(callback));
      }
    }
    public Subscription onRemove(ro.anud.xml_xsd.implementation.util.RemoveCallback<Rule> callback) {
      try (var logger = logScope()) {
