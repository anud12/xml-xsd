...
import static ro.anud.xml_xsd.implementation.util.LocalLogger.logReturn;
  ...
  public class NameRule  {
    ...
    public static Optional<NameRule> fromRawNode(Optional<RawNode> rawNode) {
        logEnter();
        return logReturn(rawNode.map(NameRule::fromRawNode));
    }
    public static List<NameRule> fromRawNode(List<RawNode> rawNodeList) {
      logEnter();
      List<NameRule> returnList = rawNodeList.stream().map(NameRule::fromRawNode).collect(Collectors.toList());
      return logReturn(returnList);
    }

    public Runnable onChange(Consumer<NameRule> onChange) {
    ...
    public void deserialize (RawNode rawNode) {
      ...
      this.entry = ro.anud.xml_xsd.implementation.model.Group_nameToken.Group_nameToken.fromRawNode(rawNode.getChildrenList("entry"));
    }
    ...
    public NameRule setEntry(List<ro.anud.xml_xsd.implementation.model.Group_nameToken.Group_nameToken> value)
    {
      this.entry = value;
