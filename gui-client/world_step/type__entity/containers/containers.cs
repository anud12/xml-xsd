...
namespace XSD.Ntype__entity {
  public class containers : IEquatable<containers>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".type__entity.containers";
    ...
    private LinkedNodeCollection<XSD.Ntype__entity.Ncontainers.container> _container = new();
    public LinkedNodeCollection<XSD.Ntype__entity.Ncontainers.container> container
    {
      get => _container;
      set
      {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntype__entity.Ncontainers.container> container)
      {
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntype__entity.Ncontainers.container>)
      {
        this.container = null;
      }
    }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Ntype__entity.Ncontainers.container.TagName + "["))
      {
        var startIndex = (XSD.Ntype__entity.Ncontainers.container.TagName + "[").Length;
        var startTokens = xpath.Split(XSD.Ntype__entity.Ncontainers.container.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Ntype__entity.Ncontainers.container.TagName + "[" + indexString + "]", "");
        ...
        var newEntry = new XSD.Ntype__entity.Ncontainers.container();
    ...
    {
      if(linkedNode is XSD.Ntype__entity.Ncontainers.container casted_container) {
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Ntype__entity.Ncontainers.container
      || false;
    }
