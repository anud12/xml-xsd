...
namespace XSD.Ntype__entity.Ncontainers.Ncontainer.Nentities.Nentity {}
namespace XSD {
}
namespace XSD.Ntype__entity.Ncontainers.Ncontainer.Nentities {
  public class entity : IEquatable<entity>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".type__entity.containers.container.entities.entity";
