...
namespace XSD.Ntype__node_graph__selection {
  public class has__node_graph_id : XSD.ILinkedNode  {
    ...
    private List<Action<has__node_graph_id>> _onSelfChangeCallbackList = new();
    ...
    {
      if(name == "node_graph_id_ref")
      {
        Set_node_graph_id_ref(value);
      }
    }
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntype__node_graph__selection.Nhas__node_graph_id.or> or)
      {
        this.or = or;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntype__node_graph__selection.Nhas__node_graph_id.or>)
      {
        this.or = null;
      }
    }

    public Action OnSelfChange(Action<has__node_graph_id> callback)
    {
