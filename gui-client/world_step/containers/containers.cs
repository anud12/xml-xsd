...
namespace XSD {
  public class containers : IEquatable<containers>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".containers";
    ...
    private LinkedNodeCollection<XSD.Ncontainers.container> _container = new();
    public LinkedNodeCollection<XSD.Ncontainers.container> container
    {
      get => _container;
      set
      {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ncontainers.container> container)
      {
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ncontainers.container>)
      {
        this.container = null;
      }
    }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Ncontainers.container.TagName + "["))
      {
        var startIndex = (XSD.Ncontainers.container.TagName + "[").Length;
        var startTokens = xpath.Split(XSD.Ncontainers.container.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Ncontainers.container.TagName + "[" + indexString + "]", "");
        ...
        var newEntry = new XSD.Ncontainers.container();
    ...
    {
      if(linkedNode is XSD.Ncontainers.container casted_container) {
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Ncontainers.container
      || false;
    }
