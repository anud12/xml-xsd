...
namespace XSD {
  public class name_token : IEquatable<name_token>, XSD.ILinkedNode  {
    ...
    public XSD.Nname_token._ref _refOrCreate
    {
      get
      {
        if(__ref == null)
    ...
    public XSD.Nname_token.one_of one_ofOrCreate
    {
      get
      {
        if(_one_of == null)
    ...
    {
      if(linkedNode is XSD.Nname_token._ref _ref)
      {
        this._ref = _ref;
      }

      if(linkedNode is XSD.Nname_token.one_of one_of)
      {
        this.one_of = one_of;
      }
    ...
    {
      if(linkedNode is XSD.Nname_token._ref)
      {
        this._ref = null;
      }

      if(linkedNode is XSD.Nname_token.one_of)
      {
        this.one_of = null;
      }
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nname_token._ref
      || candidateChild is XSD.Nname_token.one_of
      || false;
    }
