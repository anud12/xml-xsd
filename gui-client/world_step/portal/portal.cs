...
namespace XSD.Nportal {}
namespace XSD {
}
namespace XSD {
  public class portal : IEquatable<portal>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".portal";
    ...
    //Children elements
    private XSD.Nportal.from _from = new XSD.Nportal.from();
    public XSD.Nportal.from fromOrCreate
    {
      get
      {
        if(_from == null)
    ...
    private XSD.Nportal.to _to = new XSD.Nportal.to();
    public XSD.Nportal.to toOrCreate
    {
      get
      {
        if(_to == null)
    ...
    {
      if(linkedNode is XSD.Nportal.from from)
      {
        this.from = from;
      }

      if(linkedNode is XSD.Nportal.to to)
      {
        this.to = to;
      }
    ...
    {
      if(linkedNode is XSD.Nportal.from)
      {
        this.from = new();
      }

      if(linkedNode is XSD.Nportal.to)
      {
        this.to = new();
      }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nportal.from.TagName))
      {
        var childXPath = xpath.Substring(XSD.Nportal.from.TagName.Length + 3);
        this.from.DeserializeAtPath(childXPath, rawNode);
        return;
      }
      if(xpath.StartsWith(XSD.Nportal.to.TagName))
      {
        var childXPath = xpath.Substring(XSD.Nportal.to.TagName.Length + 3);
    ...
    {
      if(linkedNode is XSD.Nportal.from casted_from) {
        return 0;
      }
      if(linkedNode is XSD.Nportal.to casted_to) {
        return 0;
      }
      return null;
    }
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nportal.from
      || candidateChild is XSD.Nportal.to
      || false;
    }
