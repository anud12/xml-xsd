...
namespace XSD.Nportal {
  public class to : IEquatable<to>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".portal.to";
    ...
    //Children elements
    private XSD.Nportal.Nto.region _region = new XSD.Nportal.Nto.region();
    public XSD.Nportal.Nto.region regionOrCreate
    {
      get
      {
        if(_region == null)
    ...
    public XSD.Nportal.Nto.region region
    {
      get
      {
        return _region;
    ...
    {
      if(linkedNode is XSD.Nportal.Nto.region region)
      {
        this.region = region;
      }
    ...
    {
      if(linkedNode is XSD.Nportal.Nto.region)
      {
        this.region = new();
      }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nportal.Nto.region.TagName))
      {
        var childXPath = xpath.Substring(XSD.Nportal.Nto.region.TagName.Length + 3);
    ...
    {
      if(linkedNode is XSD.Nportal.Nto.region casted_region) {
        return 0;
      }
      return null;
    }
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nportal.Nto.region
      || false;
    }
