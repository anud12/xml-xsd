...
namespace XSD.Ntext_map {}
namespace XSD {
}
namespace XSD {
  public class text_map : IEquatable<text_map>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".text_map";
    ...
    private LinkedNodeCollection<XSD.Ntext_map.text> _text = new();
    public LinkedNodeCollection<XSD.Ntext_map.text> text
    {
      get => _text;
      set
      {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntext_map.text> text)
      {
        this.text = text;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Ntext_map.text>)
      {
        this.text = null;
      }
    }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Ntext_map.text.TagName + "["))
      {
        var startIndex = (XSD.Ntext_map.text.TagName + "[").Length;
        var startTokens = xpath.Split(XSD.Ntext_map.text.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Ntext_map.text.TagName + "[" + indexString + "]", "");
        ...
        var newEntry = new XSD.Ntext_map.text();
    ...
    {
      if(linkedNode is XSD.Ntext_map.text casted_text) {
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Ntext_map.text
      || false;
    }
