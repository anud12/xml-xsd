...
namespace XSD.Ntype__region_rule.Nportal.Nfrom {}
namespace XSD {
}
namespace XSD.Ntype__region_rule.Nportal {
  public class from : IEquatable<from>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".type__region_rule.portal.from";
    ...
    public bool Equals(from? obj)
    {
        ...
        var other = (from)obj;
        return Equals(side, other.side) && Equals(start, other.start) && Equals(width, other.width);
    }
