...
namespace XSD.Ngroup__name_token {
  public class name_token  {
    ...
    public XSD.Ngroup__name_token.Nname_token._ref? Get__ref()
    {
      return this._ref;
    }
    public XSD.Ngroup__name_token.Nname_token._ref GetOrInsertDefault__ref()
    {
      if(this._ref == null) {
        this._ref = new XSD.Ngroup__name_token.Nname_token._ref();
      }
      return this._ref;
    }
    public void Set__ref(XSD.Ngroup__name_token.Nname_token._ref? value)
    {
      this._ref = value;
    }
