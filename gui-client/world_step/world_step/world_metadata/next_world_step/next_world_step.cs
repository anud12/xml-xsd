...
namespace XSD.Nworld_step.Nworld_metadata {
  public class next_world_step : XSD.ILinkedNode  {
    ...
    private List<Action<next_world_step>> _callbackList = new();
    ...
    public Action OnChange(Action<next_world_step> callback)
    {
