...
namespace XSD.Nworld_step.Nworld_metadata {
  public class previous_world_step : IEquatable<previous_world_step>, XSD.ILinkedNode  {
    ...
    private List<Action<previous_world_step>> _onSelfChangeCallbackList = new();
    ...
    public Action OnSelfChange(Action<previous_world_step> callback)
    {
    ...
    public bool Equals(previous_world_step? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (previous_world_step)obj;
