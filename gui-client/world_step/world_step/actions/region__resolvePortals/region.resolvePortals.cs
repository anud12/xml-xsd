...
namespace XSD.Nworld_step.Nactions.Nregion__resolvePortals {}
namespace XSD {
}
namespace XSD.Nworld_step.Nactions {
  public class region__resolvePortals : IEquatable<region__resolvePortals>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".world_step.actions.region.resolvePortals";
    public static string TagName = "region.resolvePortals";

    public string NodeName {get =>"region.resolvePortals";}
    public RawNode rawNode = new RawNode();

    private ILinkedNode? _parentNode;
    public ILinkedNode? ParentNode {get => _parentNode; set => _parentNode = value;}
    private List<Action<region__resolvePortals>> _onSelfChangeCallbackList = new();
    ...
    //Children elements
    public region__resolvePortals()
    {
    }

    public region__resolvePortals(RawNode rawNode)
    {
      Deserialize(rawNode);
    }

    public region__resolvePortals(XmlElement xmlElement)
    {
    ...
    public Action OnSelfChange(Action<region__resolvePortals> callback)
    {
    ...
    public void Deserialize (RawNode rawNode)
    {
      ...
      // Godot.GD.Print("Deserializing region.resolvePortals");
    ...
    public bool Equals(region__resolvePortals? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (region__resolvePortals)obj;
