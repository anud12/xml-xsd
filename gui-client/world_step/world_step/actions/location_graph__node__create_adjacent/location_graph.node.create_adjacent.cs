...
namespace XSD.Nworld_step.Nactions {
  public class location_graph__node__create_adjacent : XSD.ILinkedNode  {
    ...
    private List<Action<location_graph__node__create_adjacent>> _onSelfChangeCallbackList = new();
    ...
    public Action OnSelfChange(Action<location_graph__node__create_adjacent> callback)
    {
