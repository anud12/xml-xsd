...
namespace XSD.Nworld_step.Nrule_group.Nentity_rule.Nentry.Ncontainers.Ncontainer {}
namespace XSD {
}
namespace XSD.Nworld_step.Nrule_group.Nentity_rule.Nentry.Ncontainers {
  public class container : IEquatable<container>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".world_step.rule_group.entity_rule.entry.containers.container";
