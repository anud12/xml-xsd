...
namespace XSD.Nworld_step.Nrule_group.Nentity_rule.Nentry.Nstrings.Nstring {}
namespace XSD {
}
namespace XSD.Nworld_step.Nrule_group.Nentity_rule.Nentry.Nstrings {
  public class string : IEquatable<string>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".world_step.rule_group.entity_rule.entry.strings.string";
