...
namespace XSD.Nworld_step.Nrule_group.Nportal_rule.Nentry {}
namespace XSD {
  public interface Itype__portal_rule {

    //Children elements
    public XSD.Ntype__portal_rule.limit limit { get; set; }
    public XSD.Ntype__portal_rule.to to { get; set; }
...
namespace XSD.Nworld_step.Nrule_group.Nportal_rule {
  public class entry : IEquatable<entry>, XSD.ILinkedNode , Itype__portal_rule {

    public static string ClassTypeId = ".world_step.rule_group.portal_rule.entry";
