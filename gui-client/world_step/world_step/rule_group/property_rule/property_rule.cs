...
namespace XSD.Nworld_step.Nrule_group {
  public class property_rule : IEquatable<property_rule>, XSD.ILinkedNode  {
    ...
    private List<Action<property_rule>> _onSelfChangeCallbackList = new();
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Nrule_group.Nproperty_rule.entry> entry)
      {
        this.entry = entry;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Nrule_group.Nproperty_rule.entry>)
      {
        this.entry = null;
      }
    }

    public Action OnSelfChange(Action<property_rule> callback)
    {
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nworld_step.Nrule_group.Nproperty_rule.entry.TagName + "["))
      {
        ...
        var startTokens = xpath.Split(XSD.Nworld_step.Nrule_group.Nproperty_rule.entry.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Nworld_step.Nrule_group.Nproperty_rule.entry.TagName + "[" + indexString + "]", "");
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nworld_step.Nrule_group.Nproperty_rule.entry
      || false;
    }

    public bool Equals(property_rule? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (property_rule)obj;
