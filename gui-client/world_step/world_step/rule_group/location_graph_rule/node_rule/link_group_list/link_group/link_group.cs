...
namespace XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list {
  public class link_group  {
    ...
    //Children elements
    public List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option>? to_option = new List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option>();
    public link_group()
    {
    }
    ...
    public List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option>? Get_to_option()
    {
      return this.to_option;
    }
    public List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option> GetOrInsertDefault_to_option()
    {
      if(this.to_option == null) {
        this.to_option = new List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option>();
      }
      return this.to_option;
    }
    public void Set_to_option(List<XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nnode_rule.Nlink_group_list.Nlink_group.to_option>? value)
    {
