...
namespace XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nsetup.Nstarting_node {}
namespace XSD {
}
namespace XSD.Nworld_step.Nrule_group.Nlocation_graph_rule.Nsetup {
  public class starting_node : IEquatable<starting_node>, XSD.ILinkedNode  {
    ...
    public string NodeName {get =>"starting_node";}
    public RawNode rawNode = new RawNode();

    private ILinkedNode? _parentNode;
    public ILinkedNode? ParentNode {get => _parentNode; set => _parentNode = value;}
    private List<Action<starting_node>> _onSelfChangeCallbackList = new();
    ...
    public starting_node(RawNode rawNode)
    {
      Deserialize(rawNode);
    }

    public starting_node(XmlElement xmlElement)
    {
    ...
    public Action OnSelfChange(Action<starting_node> callback)
    {
    ...
    public bool Equals(starting_node? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (starting_node)obj;
        return Equals(node_rule_ref, other.node_rule_ref);
    }
