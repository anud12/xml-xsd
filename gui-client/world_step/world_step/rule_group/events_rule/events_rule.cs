...
namespace XSD.Nworld_step.Nrule_group {
  public class events_rule  {
    ...
    public string Tag = "events_rule";
    public RawNode rawNode = new RawNode();
    //Attributes

    //Children elements

    private Dictionary<int, XSD.Nworld_step.Nrule_group.Nevents_rule.entry> _entry = new Dictionary<int, XSD.Nworld_step.Nrule_group.Nevents_rule.entry>();
    public List<XSD.Nworld_step.Nrule_group.Nevents_rule.entry> entry {
    ...
    public List<XSD.Nworld_step.Nrule_group.Nevents_rule.entry> GetOrInsertDefault_entry()
    {
      if(this._entry == null) {
        ...
        // false2
        this._entry = new Dictionary<int, XSD.Nworld_step.Nrule_group.Nevents_rule.entry>();
      }
