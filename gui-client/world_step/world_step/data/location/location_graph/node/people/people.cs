...
namespace XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode {
  public class people : IEquatable<people>, XSD.ILinkedNode  {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person> person)
      {
        this.person = person;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person>)
      {
        this.person = null;
      }
    }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person.TagName + "["))
      {
        ...
        var startTokens = xpath.Split(XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person.TagName + "[" + indexString + "]", "");
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nworld_step.Ndata.Nlocation.Nlocation_graph.Nnode.Npeople.person
      || false;
    }

    public bool Equals(people? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (people)obj;
