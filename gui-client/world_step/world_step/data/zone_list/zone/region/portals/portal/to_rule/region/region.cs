...
namespace XSD.Nworld_step.Ndata.Nzone_list.Nzone.Nregion.Nportals.Nportal.Nto_rule.Nregion {}
namespace XSD {
}
namespace XSD.Nworld_step.Ndata.Nzone_list.Nzone.Nregion.Nportals.Nportal.Nto_rule {
  public class region : IEquatable<region>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".world_step.data.zone_list.zone.region.portals.portal.to_rule.region";
