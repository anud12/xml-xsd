...
namespace XSD.Nworld_step.Ndata.NNodes.NNode.NOrigin {}
namespace XSD {
}
namespace XSD.Nworld_step.Ndata.NNodes.NNode {
  public class Origin : IEquatable<Origin>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".world_step.data.Nodes.Node.Origin";
    public static string TagName = "Origin";

    public string NodeName {get =>"Origin";}
    public RawNode rawNode = new RawNode();

    private ILinkedNode? _parentNode;
    public ILinkedNode? ParentNode {get => _parentNode; set => _parentNode = value;}
    private List<Action<Origin>> _onSelfChangeCallbackList = new();
    ...
    public Origin(RawNode rawNode)
    {
      Deserialize(rawNode);
    }

    public Origin(XmlElement xmlElement)
    {
    ...
    public Action OnSelfChange(Action<Origin> callback)
    {
    ...
    public void Deserialize (RawNode rawNode)
    {
      ...
      // Godot.GD.Print("Deserializing Origin");
    ...
    {
        // Godot.GD.Print("Serializing Origin");
    ...
    public bool Equals(Origin? obj)
    {
        if (obj == null || GetType() != obj.GetType())
            return false;

        var other = (Origin)obj;
