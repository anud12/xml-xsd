...
namespace XSD.Nworld_step.Ndata.NNodes.NNode.NPortals.NPortal.NFrom {}
namespace XSD {
}
namespace XSD.Nworld_step.Ndata.NNodes.NNode.NPortals.NPortal {
  public class From : IEquatable<From>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".world_step.data.Nodes.Node.Portals.Portal.From";
    ...
    public bool Equals(From? obj)
    {
        ...
        var other = (From)obj;
        return Equals(side, other.side) && Equals(position, other.position) && Equals(maxWidth, other.maxWidth);
    }
