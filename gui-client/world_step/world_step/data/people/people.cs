...
namespace XSD.Nworld_step.Ndata {
  public class people  {
    ...
    private Dictionary<int, XSD.Nworld_step.Ndata.Npeople.person> _person = new Dictionary<int, XSD.Nworld_step.Ndata.Npeople.person>();
    public List<XSD.Nworld_step.Ndata.Npeople.person> person {
    ...
    public List<XSD.Nworld_step.Ndata.Npeople.person> GetOrInsertDefault_person()
    {
      if(this._person == null) {
        ...
        // false2
        this._person = new Dictionary<int, XSD.Nworld_step.Ndata.Npeople.person>();
      }
