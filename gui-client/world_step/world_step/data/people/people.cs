...
namespace XSD.Nworld_step.Ndata {
  public class people : IEquatable<people>, XSD.ILinkedNode  {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.person> person)
      {
        this.person = person;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.person>)
      {
        this.person = null;
      }
    }
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nworld_step.Ndata.Npeople.person
      || false;
    }
