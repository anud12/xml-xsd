...
namespace XSD.Nworld_step.Ndata.Npeople.Nperson {
  public class classifications : IEquatable<classifications>, XSD.ILinkedNode  {
    ...
    private LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification> _classification = new();
    public LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification> classification
    {
      get => _classification;
      set
      {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification> classification)
      {
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification>)
      {
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification.TagName + "["))
      {
        ...
        var startTokens = xpath.Split(XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification.TagName + "[" + indexString + "]", "");
    ...
    {
      if(linkedNode is XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification casted_classification) {
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nworld_step.Ndata.Npeople.Nperson.Nclassifications.classification
      || false;
    }
