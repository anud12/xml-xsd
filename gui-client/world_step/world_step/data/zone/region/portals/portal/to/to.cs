...
namespace XSD.Nworld_step.Ndata.Nzone.Nregion.Nportals.Nportal.Nto {}
namespace XSD {
}
namespace XSD.Nworld_step.Ndata.Nzone.Nregion.Nportals.Nportal {
  public class to : IEquatable<to>, XSD.ILinkedNode  {

    public static string ClassTypeId = ".world_step.data.zone.region.portals.portal.to";
    ...
    public bool Equals(to? obj)
    {
        ...
        var other = (to)obj;
        return Equals(zone_ref, other.zone_ref) && Equals(region_ref, other.region_ref) && Equals(side, other.side) && Equals(position, other.position) && Equals(maxWidth, other.maxWidth);
    }
