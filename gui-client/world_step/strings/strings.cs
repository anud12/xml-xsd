...
namespace XSD {
  public class strings : IEquatable<strings>, XSD.ILinkedNode  {
    ...
    public static string ClassTypeId = ".strings";
    ...
    private LinkedNodeCollection<XSD.Nstrings.string> _string = new();
    public LinkedNodeCollection<XSD.Nstrings.string> string
    {
      get => _string;
      set
      {
    ...
    public void SetChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nstrings.string> string)
      {
        this.string = string;
      }
    }
    ...
    public void ClearChild(dynamic linkedNode)
    {
      ...
      if(linkedNode is LinkedNodeCollection<XSD.Nstrings.string>)
      {
        this.string = null;
      }
    }
    ...
    public void DeserializeAtPath(string xpath, RawNode rawNode)
    {
      ...
      if(xpath.StartsWith(XSD.Nstrings.string.TagName + "["))
      {
        var startIndex = (XSD.Nstrings.string.TagName + "[").Length;
        var startTokens = xpath.Split(XSD.Nstrings.string.TagName + "[");
        var endToken = startTokens[1].Split("]");
        var indexString = endToken[0];
        var childXPath = xpath.ReplaceFirst(XSD.Nstrings.string.TagName + "[" + indexString + "]", "");
        ...
        var newEntry = new XSD.Nstrings.string();
    ...
    {
      if(linkedNode is XSD.Nstrings.string casted_string) {
    ...
    public bool IsValidChildType(ILinkedNode candidateChild) {
      return candidateChild is XSD.Nstrings.string
      || false;
    }
