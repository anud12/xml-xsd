package ro.anud.xml_xsd.specification.websocket.script.countEntity;
...
# operation.echo
## When
a server executes once per tick to count all entities in entity `1`
    in container `container_id_2`
    by id `2`
## It should
broadcast "Found entities 2"
 */
