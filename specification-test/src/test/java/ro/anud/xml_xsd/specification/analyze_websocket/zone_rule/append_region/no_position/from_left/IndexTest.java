package ro.anud.xml_xsd.specification.analyze_websocket.zone_rule.append_region.no_position.from_left;
...
/*description
#Append region from left side
##When
- an append region rule is applied to a zone
- without offset
- from left side portal
