package ro.anud.xml_xsd.specification.analyze_websocket.zone_rule.append_region.different_rotation.from_rotation_normal.from_left_portal.to_left_portal;
...
/*description
#Append region from left portal to target left portal
##When
...
```
From left to left = "inverted"
```

* translate destination portal
```
y = y - ToPortalStart - PortalWidth + (NewRegionHeight / 2)
y = y - 1 - 2 + 3
 x:95,y:1002 ->  x:95,y:1003
```
