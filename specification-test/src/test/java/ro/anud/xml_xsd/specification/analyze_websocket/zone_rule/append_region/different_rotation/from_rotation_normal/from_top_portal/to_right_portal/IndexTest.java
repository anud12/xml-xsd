package ro.anud.xml_xsd.specification.analyze_websocket.zone_rule.append_region.different_rotation.from_rotation_normal.from_top_portal.to_right_portal;
...
/*description
#Append region from top portal to target right portal
##When
...
```
From top to left = "clockwise"
```

* translate destination portal
```
x = x - ToPortalStart - (portalSize) + (NewRegionHeight / 2)
 x:98,y:1003 ->  x:98,y:1003
```
