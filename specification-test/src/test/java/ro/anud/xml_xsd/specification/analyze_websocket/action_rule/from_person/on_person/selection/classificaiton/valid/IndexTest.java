package ro.anud.xml_xsd.specification.analyze_websocket.action_rule.from_person.on_person.selection.classificaiton.valid;
...
/*description
# `from_person` action with valid `classification` selection set on `on_person`
## When
