package ro.anud.xml_xsd.specification.analyze_websocket.zone_rule.append_region.different_rotation.from_rotation_normal.from_left_portal.to_top_portal;
...
```
y = y + ToPortalStart - (NewRegionHeight / 2)
y = y + 3 - 5
 x:95,y:1002 ->  x:95,y:1000
```
